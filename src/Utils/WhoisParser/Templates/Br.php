...
class Br extends Regex
{
     ...
     * @access protected
     */
    protected $available = '/(No match for domain|release process: reserved|No match for)/i';
	...
	public function postProcess(&$WhoisParser)
	{
		...
		if(strpos($ResultSet->created, '#')){
			$ResultSet->created = explode(' ', $ResultSet->created)[0];
		}
	}
}