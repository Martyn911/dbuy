...
class BlogControllerTest extends WebTestCase
{
    ...
    public function testAdminShowPost()
    {
        ...
        $client->request('GET', '/en/admin/post/31');
    ...
    {
        $newBlogPostTitle = 'Lorem ipsum dolor sit amet consectetur adipiscing elit '.mt_rand();

        $client = static::createClient([], [
            'PHP_AUTH_USER' => 'jane_admin',
            'PHP_AUTH_PW' => 'kitten',
        ]);
        $crawler = $client->request('GET', '/en/admin/post/31/edit');
    ...
    public function testAdminDeletePost()
    {
        ...
        $crawler = $client->request('GET', '/en/admin/post/31');
